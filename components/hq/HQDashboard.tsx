...
// Fix: Add MenuItem to imports to be used in props interface.
import { Restaurant, StaffRole, RestaurantView, StaffMember, MenuItem } from '../../types';
import { 
...
interface RestaurantDashboardProps {
  ...
  // Fix: Add missing 'onUpdateMenuItem' prop.
